...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [[INUDataManager sharedInstance] notifyAppToFront];
    [[INUDataManager sharedInstance] requestNotificationsWithCompletionHandler:nil];
}
...
{
    [[INUDataManager sharedInstance] requestNotificationsWithCompletionHandler:completionHandler];
}
